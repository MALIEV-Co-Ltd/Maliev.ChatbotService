...
public class ToolExecutorService : IToolExecutorService
{
    ...
    public ToolExecutorService(IHttpClientFactory httpClientFactory, ILogger<ToolExecutorService> logger)
    {
        ...
        _handlers = new Dictionary<string, IToolHandler>
        {
            ...
            ["quote_get_project_summary"] = quoteEngineHandler,
            ["quote_get_connectors"] = quoteEngineHandler,
            ["quote_get_connector_handoff"] = quoteEngineHandler,
            ["quote_register_uploads"] = quoteEngineHandler,
            ["quote_generate_3d_preview"] = quoteEngineHandler,
            ["quote_cad_start_design"] = quoteEngineHandler,
            ["quote_cad_apply_operations"] = quoteEngineHandler,
            ["quote_cad_observe_design"] = quoteEngineHandler,
            ["quote_cad_finalize_preview"] = quoteEngineHandler,
            ...
            ["quote_prepare_address"] = quoteEngineHandler,
            ...
            ["quote_request_employee_review"] = quoteEngineHandler,
