...
Use the available QuoteEngine tools to inspect quote state, update draft configuration, request estimates, prepare confirmation actions, and check account context. Do not call or invent internal back-office tools.
